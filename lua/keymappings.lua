...
local mappings = {
    ...
    n = { -- Normal mode
        ...
        {"<C-h>", "<C-w>h", {silent = true}}, {"<C-j>", "<C-w>j", {silent = true}},
        {"<C-k>", "<C-w>k", {silent = true}}, {"<C-l>", "<C-w>l", {silent = true}},

        {'<C-w><Left>', '<C-w>h', {silent = true}}, {'<C-w><Down>', '<C-w>j', {silent = true}},
        {'<C-w><Up>', '<C-w>k', {silent = true}}, {'<C-w><Right>', '<C-w>l', {silent = true}},

        {']', '<cmd>lua require "gitsigns".next_hunk()<cr>', {noremap = true, silent = true}},
