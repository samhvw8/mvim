...
local capabilities_snip = vim.lsp.protocol.make_client_capabilities()
capabilities_snip.textDocument.completion.completionItem.snippetSupport = true
capabilities_snip.textDocument.completion.completionItem.resolveSupport = {
