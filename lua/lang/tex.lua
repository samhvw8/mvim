...
M.config = function()
    O.lang.latex = {
        ...
        chktex = {on_open_and_save = false, on_edit = false},
        forward_search = {executable = nil, args = {}},
        latexindent = {["local"] = nil, modify_line_breaks = false},
...
M.lint = function()
    require("lint").linters_by_ft = {tex = O.lang.latex.linters}
end

M.lsp = function()
    if require("gv-utils").check_lsp_client_active "texlab" then return end
    ...
    require("lspconfig").texlab.setup {
        ...
        settings = {
            texlab = {
                ...
                chktex = {onEdit = O.lang.latex.chktex.on_edit, onOpenAndSave = O.lang.latex.chktex.on_open_and_save},
                diagnosticsDelay = O.lang.latex.diagnostics_delay,
                formatterLineLength = O.lang.latex.formatter_line_length,
                forwardSearch = {args = preview_settings, executable = O.lang.latex.forward_search.executable},
                latexFormatter = O.lang.latex.latex_formatter,
                latexindent = {modifyLineBreaks = O.lang.latex.latexindent.modify_line_breaks}
            }
        }
    }
    ...
    if O.lang.latex.auto_save then vim.api.nvim_exec([[au FocusLost * :wa]], false) end
end
