...
M.config = function()
    O.lang.php = {
        ...
        filetypes = {"php", "phtml"},
        formatter = {exe = "phpcbf", args = {"--standard=PSR12", vim.api.nvim_buf_get_name(0)}, stdin = false}
    }
end
...
M.lsp = function()
    if require("gv-utils").check_lsp_client_active "intelephense" then return end
